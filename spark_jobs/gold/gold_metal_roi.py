...
def daily_metal_prices(spark: SparkSession) -> DataFrame:
    ...
    # LBMA's PM fix is the conventional benchmark reference price; fall back to the AM
    # fix, then to whatever single daily print exists (silver's "default" session).
