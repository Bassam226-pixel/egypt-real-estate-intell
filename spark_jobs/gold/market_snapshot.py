...
# EGX30, metal spot, and FX rates don't share a natural wide-table shape (different
# entities, different metrics, different units) -- kept as a tidy (metric, value, unit)
# fact table instead of one sparse-null-filled row per as_of_date.
